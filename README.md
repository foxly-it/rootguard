...
curl -LO https://raw.githubusercontent.com/foxly-it/rootguard/v1.0.0-rc.3/compose.release.yaml
curl -Lo .env https://raw.githubusercontent.com/foxly-it/rootguard/v1.0.0-rc.3/.env.release.example
```
