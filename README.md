...
curl -LO https://raw.githubusercontent.com/foxly-it/rootguard/v1.0.0-rc.4/compose.release.yaml
curl -Lo .env https://raw.githubusercontent.com/foxly-it/rootguard/v1.0.0-rc.4/.env.release.example
```
