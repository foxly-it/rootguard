...
// an already-qualified image reached this function unguarded. imageRepo's
// own colon-splitting only accounts for a tag separator, not a digest's
// internal colon, so it silently mis-split the reference and this
// function appended a second "@sha256:..." on top of the first, producing
// an invalid, doubled reference. digestQualify already special-cased this
// exact input shape; this function needed the identical guard.
