...
!!! example "Worked example"
    A complete, worked-through zone (`home.lan` with A, AAAA, and derived PTR records) is in [Local DNS zones](../guides/local-dns-zones.md).
...
!!! example "Worked example"
    Step-by-step walkthrough in [Importing devices from your FRITZ!Box](../guides/fritzbox-import.md), including the router-independent reverse-DNS alternative.
...
!!! example "Worked example"
    A worked-through example is in [Private domains and reverse DNS](../guides/private-domains-reverse-dns.md).
...
!!! example "Worked example"
    A worked-through forwarding example is in [Conditional forwarding](../guides/conditional-forwarding.md).
