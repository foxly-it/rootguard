...
export default function Setup() {
  ...
  const [config, setConfig] = useState<InstallationConfig>(() => ({
    ...defaultConfig,
    dns_bind_address: detectDefaultBindAddress(window.location.hostname),
  }));
    ...
    <div className="setup-page">
      ...
      <section className="setup-card network-card">
        ...
        <fieldset className="release-channel blockpage-toggle" disabled={deploying}>
          ...
          <a
            className="rg-button rg-button-secondary blockpage-preview-button"
            href="/blockpage-preview/"
            target="_blank"
